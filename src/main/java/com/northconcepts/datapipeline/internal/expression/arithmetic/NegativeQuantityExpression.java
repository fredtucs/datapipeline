...
public class NegativeQuantityExpression extends UnaryArithmeticExpression
{
    public NegativeQuantityExpression(final ArithmeticExpression arithmeticExpression1) {
