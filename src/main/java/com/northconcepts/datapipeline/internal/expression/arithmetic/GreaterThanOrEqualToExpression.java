...
public class GreaterThanOrEqualToExpression extends BinaryArithmeticRelationalExpression
{
    public GreaterThanOrEqualToExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
