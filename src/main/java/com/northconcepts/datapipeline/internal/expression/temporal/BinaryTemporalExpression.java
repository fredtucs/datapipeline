...
public abstract class BinaryTemporalExpression extends TemporalExpression
{
    private final TemporalExpression temporalExpression1;
    private final TemporalExpression temporalExpression2;
    
    public BinaryTemporalExpression(final TemporalExpression temporalExpression1, final TemporalExpression temporalExpression2) {
        super();
    ...
    public boolean expressionsAreMomentAndInterval() {
        return this.temporalExpression1 instanceof MomentExpression && this.temporalExpression2 instanceof IntervalExpression;
    }
    
    protected void throwTypeMismatchException(final String message) {
        throw new DataException(message + ", " + "but found [" + TypeUtil.getJavaName(this.getTemporalExpression1().getClass()) + "] and " + "[" + TypeUtil.getJavaName(this.getTemporalExpression2().getClass()) + "] instead");
    }
}
