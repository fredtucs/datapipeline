...
public class UntypedGreaterThanOrEqualToExpression extends UntypedRelationalExpression
{
    public UntypedGreaterThanOrEqualToExpression(final Expression expression1, final Expression expression2) {
	...
	public boolean evaluateBoolean(final Interval o1, final Interval o2) {
        return o1.isGreaterThanOrEqualTo(o2);
    }
