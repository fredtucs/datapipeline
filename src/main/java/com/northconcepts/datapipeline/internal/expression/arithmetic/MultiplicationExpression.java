...
public class MultiplicationExpression extends BinaryArithmeticExpression
{
    public MultiplicationExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
