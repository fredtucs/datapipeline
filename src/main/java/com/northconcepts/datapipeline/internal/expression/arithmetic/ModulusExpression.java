...
public class ModulusExpression extends BinaryArithmeticExpression
{
    public ModulusExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
