...
public class LessThanExpression extends BinaryArithmeticRelationalExpression
{
    public LessThanExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
