...
public class DivisionExpression extends BinaryArithmeticExpression
{
    public DivisionExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
