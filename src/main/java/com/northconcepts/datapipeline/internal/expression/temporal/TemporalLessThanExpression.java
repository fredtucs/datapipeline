...
public class TemporalLessThanExpression extends BinaryTemporalRelationalExpression
{
    public TemporalLessThanExpression(final TemporalExpression temporalExpression1, final TemporalExpression temporalExpression2) {
	...
	public boolean evaluateBoolean(final ExpressionContext expressionContext) {
        if (this.expressionsAreIntervals()) {
            ...
            return o1.evaluateInterval(expressionContext).isLessThan(o2.evaluateInterval(expressionContext));
        }
        if (this.expressionsAreMoments()) {
            ...
            return o3.evaluateMoment(expressionContext).isLessThan(o4.evaluateMoment(expressionContext));
        }
