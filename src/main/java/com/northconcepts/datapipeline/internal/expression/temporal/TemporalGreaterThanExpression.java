...
public class TemporalGreaterThanExpression extends BinaryTemporalRelationalExpression
{
    public TemporalGreaterThanExpression(final TemporalExpression temporalExpression1, final TemporalExpression temporalExpression2) {
	...
	public boolean evaluateBoolean(final ExpressionContext expressionContext) {
        if (this.expressionsAreIntervals()) {
            ...
            return o1.evaluateInterval(expressionContext).isGreaterThan(o2.evaluateInterval(expressionContext));
        }
        if (this.expressionsAreMoments()) {
            ...
            return o3.evaluateMoment(expressionContext).isGreaterThan(o4.evaluateMoment(expressionContext));
        }
