...
public class AdditionExpression extends BinaryArithmeticExpression
{
    public AdditionExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
