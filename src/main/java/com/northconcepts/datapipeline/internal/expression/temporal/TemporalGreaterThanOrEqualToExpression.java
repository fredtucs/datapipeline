...
public class TemporalGreaterThanOrEqualToExpression extends BinaryTemporalRelationalExpression
{
    public TemporalGreaterThanOrEqualToExpression(final TemporalExpression temporalExpression1, final TemporalExpression temporalExpression2) {
	...
	public boolean evaluateBoolean(final ExpressionContext expressionContext) {
        if (this.expressionsAreIntervals()) {
            ...
            return o1.evaluateInterval(expressionContext).isGreaterThanOrEqualTo(o2.evaluateInterval(expressionContext));
        }
        if (this.expressionsAreMoments()) {
            ...
            return o3.evaluateMoment(expressionContext).isGreaterThanOrEqualTo(o4.evaluateMoment(expressionContext));
        }
