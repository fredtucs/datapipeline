...
public class LessThanOrEqualToExpression extends BinaryArithmeticRelationalExpression
{
    public LessThanOrEqualToExpression(final ArithmeticExpression arithmeticExpression1, final ArithmeticExpression arithmeticExpression2) {
