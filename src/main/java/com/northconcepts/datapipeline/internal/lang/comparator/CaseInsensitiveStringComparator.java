...
public final class CaseInsensitiveStringComparator extends BaseComparator<Object>
{
    ...
    public static boolean matches(final Object o1, final Object o2) {
        return CaseInsensitiveStringComparator.INSTANCE.compare(o1, o2) == 0;
    }
    
    public static boolean before(final Object o1, final Object o2) {
        return CaseInsensitiveStringComparator.INSTANCE.compare(o1, o2) == -1;
    }
    ...
    static {
        INSTANCE = new CaseInsensitiveStringComparator();
    }
}
